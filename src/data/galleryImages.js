...
export const galleryImageData = [
  {
    ...
    getPosition: (_width, height) => [0, -height * 1.5 + 12.1, 0],
    getScale: (width, _height) => [width, 8, 1],
  },
  {
    url: 'https://i.imgur.com/om2kvnR.jpg',
    getPosition: (_width, _height) => [0, -12, 1],
    getScale: (_width, height) => [8, height, 1],
  },
  {
    url: 'https://i.imgur.com/F6D8rB4.jpg',
    getPosition: (_width, _height) => [2, -20, 0],
    getScale: (_width, _height) => [5, 5, 1],
  },
  {
    url: 'https://i.imgur.com/R9O1MVg.jpg',
    getPosition: (_width, height) => [-2, -height, 2],
    getScale: (_width, height) => [1.5, height / 2, 1],
  },
  {
    url: 'https://i.imgur.com/rrnaVCY.jpg',
    getPosition: (_width, height) => [0, -height, 2.3],
    getScale: (_width, height) => [1.5, height / 2, 1],
  },
  {
    url: 'https://i.imgur.com/zbZELzh.jpg',
    getPosition: (_width, height) => [2, -height, 2.6],
    getScale: (_width, height) => [1.5, height / 2, 1],
  },
  {
    url: 'https://i.imgur.com/3Sct6DB.jpg',
    getPosition: (_width, height) => [3.4, -height * 2 - height / 4 - 16, -1],
    getScale: (_width, _height) => [7, 5, 1],
  },
  {
    url: 'https://i.imgur.com/Vo6ouG9.jpg',
    getPosition: (_width, height) => [-5, -height * 2 - 7, -3],
    getScale: (_width, _height) => [7, 8, 1],
  },
  {
    url: 'https://i.imgur.com/Hiu4HSr.jpg',
    getPosition: (_width, height) => [2, -height * 2 - 10.5, 0],
    getScale: (_width, _height) => [4, 6, 1],
  },
  {
    url: 'https://i.imgur.com/VQJ7t82.jpg',
    getPosition: (_width, height) => [-4, -height * 2 - 16, -1],
    getScale: (_width, _height) => [5, 5, 1],
  },
  {
    url: 'https://i.imgur.com/K9mXRGW.jpg',
    getPosition: (_width, height) => [3, -height * 2 - 25, -1],
    getScale: (_width, _height) => [5, 5, 1],
  },
  {
    url: 'https://i.imgur.com/ENb1Avr.jpg',
    getPosition: (_width, height) => [-3, -height * 2 - 24, 0],
    getScale: (_width, _height) => [5, 7, 1],
  },
  {
    url: 'https://i.imgur.com/TX4JWDH.jpg',
    getPosition: (_width, height) => [3.3, -height * 2 - 32, -1],
    getScale: (_width, _height) => [5, 6, 1],
  },
  {
    url: 'https://i.imgur.com/02zrkYe.jpg',
    getPosition: (_width, height) => [2, -height * 2 - 39, 1],
    getScale: (_width, _height) => [4, 5, 1],
  },
  {
    url: 'https://i.imgur.com/65TxBm7.jpg',
    getPosition: (_width, height) => [-2, -height * 2 - 32, 1],
    getScale: (_width, _height) => [4, 5, 1],
  },
  {
    url: 'https://i.imgur.com/PWC35N5.jpg',
    getPosition: (_width, height) => [-3, -height * 2 - 38, 0],
    getScale: (_width, _height) => [5, 9, 1],
  },
  {
    url: 'https://i.imgur.com/BilMD3V.jpg',
    getPosition: (_width, height) => [0, -height * 2 - 45, 1],
    getScale: (_width, _height) => [8, 5, 1],
  },
  {
    url: 'https://i.imgur.com/TsLo9gb.jpg',
    getPosition: (_width, height) => [-2.5, -height * 2 - 52, 0],
    getScale: (_width, _height) => [5, 5, 1],
  },
  {
    url: 'https://i.imgur.com/Hoeubov.jpg',
    getPosition: (_width, height) => [3.2, -height * 2 - 53, -1],
    getScale: (_width, _height) => [5, 10, 1],
  },
  {
    url: 'https://i.imgur.com/IRyRm8O.jpg',
    getPosition: (_width, height) => [-3, -height * 2 - 60, -1],
    getScale: (_width, _height) => [5, 7, 1],
  },
  {
    url: 'https://i.imgur.com/Jcij9ZI.jpg',
    getPosition: (_width, height) => [0, -height * 2 - 67, 0.5],
    getScale: (_width, _height) => [9, 6, 1],
  },
  {
    url: 'https://i.imgur.com/XdBLDKX.jpg',
    getPosition: (_width, height) => [4, -height * 2 - 74, -2],
    getScale: (_width, _height) => [7, 5, 1],
  },
  {
    url: 'https://i.imgur.com/DRUOZFN.jpg',
    getPosition: (width, height) => [-width / 4, -height * 2 - 77, -2],
    getScale: (_width, _height) => [6, 9, 1],
  },
  {
    url: 'https://i.imgur.com/jiI9r9D.jpg',
    getPosition: (_width, height) => [0, -height * 2 - 86, 0],
    getScale: (_width, _height) => [9, 7, 1],
  },
  {
    url: 'https://i.imgur.com/YJ0Pqf0.jpg',
    getPosition: (_width, height) => [0, -height * 2 - 92, -3],
