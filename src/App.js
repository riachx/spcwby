...
function Images() {
  ...
  useFrame(({camera}) => {
    ...
    group.current.children[1].material.grayscale = 1 - data.range(1.2 / 3, 0.4 / 3) 
  ...
  return (
    <group ref={group}>
      <Image position={[-2.5, -height-12, 0]} scale={[width/3, height, 1]} url="./photos/photo4.png" />
      <Image position={[-1, -height-29.1, 3]} scale={[1.5,1.9,1]} url="./photos/photo8.png" />
      <Image position={[2.5, -height-12, 1]} scale={4} url="./photos/photo2.png" />
      <Image position={[2.0, -height-29.1, 2]} scale={[1.3, 3, 1]} url="./photos/photo6.jpg" />
      <Image position={[0.4, -height-28.8, 2.5]} scale={[1.1, 3, 1]} url="./photos/photo12.jpg" />
      <Image position={[-1.5, -height-35, 0]} scale={[width/1.5,height,1]} url="./photos/photo7.jpg" />
      <Image position={[0, -height * 2 - height / 4 - 12, 0]} scale={[width, height, 1]} url="./photos/photo1.jpg" />
      <Image position={[3.5, -height * 2 - height / 4 - 32, -1]} scale={[width/2, height, 1]} url="./photos/photo3.jpg" />
      <Image position={[0, -height * 2 - height / 4 - 42, -1]} scale={[width, height, 1]} url="./photos/groupphoto2.png" />
      <Image position={[-4, -height * 2 - height / 4 - 36, -1]} scale={5.5} url="./photos/photo13.jpeg" />
    </group>
  )
}
...
function App() {
  ...
  return (
    <Canvas gl={{ alpha: true, clearColor: 'transparent', sortObjects: true }}>
      ...
      <ScrollControls damping={1.5} pages={9}>
      <Scroll>
