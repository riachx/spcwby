...
function Item({ index, position, scale, c = new THREE.Color(), ...props }) {
  ...
  useFrame((state, delta) => {
    ...
    ref.current.material.scale[1] = ref.current.scale.y = damp(
      ref.current.scale.y,
      clicked === index && !blackphoto ? 7 : 4 + y,
      8,
      delta
    );
    ref.current.material.scale[0] = ref.current.scale.x = damp(
      ref.current.scale.x,
      clicked === index && !blackphoto ? 5 : scale[0],
      6,
      delta
    );
  ...
  return (
    <group>
      {showDance &&
        clicked !== null &&
        clicked === index && ( // Conditional rendering of the word "DANCE"
          <Text
            position={[
              position[0] - scale[0] / 4 + 5,
  ...
  return (
    ...
    >
      ...
      <Scroll>
        ...
        <Image
          url={'https://i.imgur.com/6ITXWrg.jpg'}
          position={[0.8, 0, 2.8]}
          scale={[2, 2, 0]}
        ></Image>
        ...
        <Image
          scale={[7, 4, 1]}
          position={[53.2, -0.2, 0]}
          url={'https://i.imgur.com/UCfPWTM.jpg'}
        ></Image>
        ...
        <Image
          scale={[7, 4, 1]}
          position={[93, -0.2, 0]}
          url={'https://i.imgur.com/w9bayj5.jpg'}
        ></Image>
        <Text
          position={[95.8, 0, 0]}
          fontSize={0.8}
